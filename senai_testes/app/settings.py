"""
Django settings for Aupi Django Boilerplate project.
...
AWS_S3_VERITY = config("DJANGO_AWS_S3_VERITY",
                       default=False, cast=config.boolean)
DEFAULT_FILE_STORAGE = config("DJANGO_DEFAULT_FILE_STORAGE")

JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": config("JAZZMIN_SETTINGS_SITE_TITLE"),
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": config("JAZZMIN_SETTINGS_SITE_HEADER"),
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": config("JAZZMIN_SETTINGS_SITE_BRAND"),
    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "app/static/img/admin-site-logo.png",
    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "app/static/img/admin-site-logo.png",
    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": "app/static/img/admin-site-logo-dark.png",
    # CSS classes that are applied to the logo above
    "site_logo_classes": "img",
    # Relative path to a favicon for your site, will default to site_logo if absent (ideally 32x32 px)
    "site_icon": None,
    # Welcome text on the login screen
    "welcome_sign": config("JAZZMIN_SETTINGS_SITE_WELCOME_SIGN"),
    # Copyright on the footer
    "copyright": config("JAZZMIN_SETTINGS_SITE_WELCOME_COPYRIGHT"),
    ...
    "order_with_respect_to": ["auth", "management", "books", "order"],
    ...
    "icons": {
        ...
        "management.client": "fas fa-user",
        "management.seller": "fas fa-user",
        "books": "fas fa-book",
        "books.books": "fas fa-book",
        "books.author": "fas fa-user",
        "books.publishingcompany": "fas fa-building",
        "books.bookstock": "fas fa-box",
